...
pkgname=pamac-nosnap-tray-icon-plasma
pkgver=0.1.3
pkgrel=1
...
arch=('x86_64')
license=('GPL3')
depends=('pamac-nosnap>=10.0.2' 'qt5-base>=5.15.0' 'knotifications')
makedepends=('cmake')
conflicts=('pamac-tray-appindicator')
replaces=('pamac-tray-appindicator')
options=(!emptydirs)
source=("pamac-nosnap-tray-icon-plasma-$pkgver-$pkgrel.tar.gz::$url/-/archive/$_commit/pamac-nosnap-tray-icon-plasma-$_commit.tar.gz")
